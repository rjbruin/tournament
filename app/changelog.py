...
CHANGELOG: list[dict] = [
    ...
    },
    {
        ...
        "features": [],
        "fixes": [
            "Knocked-out team names on the Teams page are no longer greyed out — the KO badge already signals their status.",
        ],
    },
    {
        "version": "1.11.2",
    ...
    },
    {
        ...
        "features": [],
        "fixes": [
            "Live knockout match scores are now fetched automatically — the background poller was previously only handling group-stage matches and silently skipping knockout fixtures.",
    ...
    },
    {
        ...
        "features": [
            ...
            "Live knockout match scores now appear on the home page fixture card, with the minute indicator — previously only the win-odds were shown.",
        ],
        "fixes": [],
    },
    {
        ...
        "features": [],
        "fixes": [
            "3rd-place standings table is now hidden once all groups have finished — it only appears while the group stage is partially complete.",
        ],
    },
    {
        "version": "1.10.1",
